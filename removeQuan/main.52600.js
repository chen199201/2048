(function () {
    ...
    function boot () {
        ...
        {
            var bundledScript = settings.debug ? 'src/project.dev.js' : 'src/project.f1616.js';
            if (jsList) {
    ...
    if (true) {
        require(window._CCSettings.debug ? 'cocos2d-js.js' : 'cocos2d-js-min.15bc1.js');
        var prevPipe = cc.loader.md5Pipe || cc.loader.assetLoader;
    ...
    if (window.document) {
        ...
        cocos2d.async = true;
        cocos2d.src = window._CCSettings.debug ? 'cocos2d-js.js' : 'cocos2d-js-min.15bc1.js';
